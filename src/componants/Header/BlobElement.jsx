...
const BlobElement = () => {
  ...
  return (
    <div className=" h-full w-full md:w-1/3 flex items-center justify-center absolute md:static shrink pr-15 overflow-hidden md:overflow-visible">
      ...
      <motion.div initial={{ filter: 'blur(5px)' }} animate={{ y: [-300, 0], opacity: [0, 1], filter: 'blur(0px)' }} transition={{ duration: 0.5,ease:'easeInOut' }} className={`flex absolute md:relative scale-40 sm:scale-60 lg:scale-80 xl:scale-75 justify-center items-center top-2 sm:top-0 md:top-20 lg:top-50 -right-47 sm:-right-30 md:right-30 lg:right-0 shrink-0 hover:animate-none animate-(--animate-wiggle-rev) rounded-full overflow-hidden
